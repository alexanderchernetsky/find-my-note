...
export const RegisterPage = () => {
    ...
    const onFinish = values => {
        ...
        if (email && password && user_name) {
            setLoading(true);
            axiosInstance
                .post('/register', {email, password, user_name})
                .then(() => {
    ...
    return (
        <div className={styles.loginPageWrapper}>
            <div className={styles.appTitle}>Register your free account</div>
            <Form name="registration-form" initialValues={{remember: false}} onFinish={onFinish} onFinishFailed={onFinishFailed} className={styles.loginForm}>
                <Item name="email" rules={[{required: true, message: 'Please input your email!', type: 'email'}]} className={styles.loginFormItem}>
                ...
                <div className={styles.signUpWrapper}>
                    ...
                    <div className={styles.signUpLink} onClick={onBackToLoginClick}>
